insert into main.accounts (id, title, currency, balance, is_closed) values
...
INSERT INTO main.operations (id, op_date,account_id,quantity,amount,op_type,subcategory_id,"comment",counterparty,is_canceled,correlation_id) VALUES
